...
JAVA_OBJECT java_security_AccessController_doPrivileged___java_security_PrivilegedExceptionAction(JAVA_OBJECT n1)
{
    ...
    XMLVMElem _r2;
    _r2.o = n1;
    XMLVM_TRY_BEGIN(w1912aaab6b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1912aaab6b1b2)
        XMLVM_CATCH_SPECIFIC(w1912aaab6b1b2,java_lang_RuntimeException,5)
        XMLVM_CATCH_SPECIFIC(w1912aaab6b1b2,java_lang_Exception,7)
    XMLVM_CATCH_END(w1912aaab6b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w1912aaab6b1b2)
    XMLVM_EXIT_METHOD()
    return _r1.o;
    label5:;
    XMLVM_SOURCE_POSITION("AccessController.java", 252)
    java_lang_Thread* curThread_w1912aaab6b1b6 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1912aaab6b1b6->fields.java_lang_Thread.xmlvmException_;
    XMLVM_SOURCE_POSITION("AccessController.java", 253)
    XMLVM_THROW_CUSTOM(_r0.o)
    label7:;
    XMLVM_SOURCE_POSITION("AccessController.java", 254)
    java_lang_Thread* curThread_w1912aaab6b1c11 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1912aaab6b1c11->fields.java_lang_Thread.xmlvmException_;
...
JAVA_OBJECT java_security_AccessController_doPrivileged___java_security_PrivilegedExceptionAction_java_security_AccessControlContext(JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    _r3.o = n1;
    _r4.o = n2;
    XMLVM_TRY_BEGIN(w1912aaab7b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1912aaab7b1b3)
        XMLVM_CATCH_SPECIFIC(w1912aaab7b1b3,java_lang_RuntimeException,8)
        XMLVM_CATCH_SPECIFIC(w1912aaab7b1b3,java_lang_Exception,11)
    XMLVM_CATCH_END(w1912aaab7b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w1912aaab7b1b3)
    XMLVM_SOURCE_POSITION("AccessController.java", 290)
    XMLVM_EXIT_METHOD()
    return _r1.o;
    label8:;
    XMLVM_SOURCE_POSITION("AccessController.java", 291)
    java_lang_Thread* curThread_w1912aaab7b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r2.o = curThread_w1912aaab7b1b8->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r2;
    XMLVM_SOURCE_POSITION("AccessController.java", 292)
    XMLVM_THROW_CUSTOM(_r0.o)
    label11:;
    XMLVM_SOURCE_POSITION("AccessController.java", 293)
    java_lang_Thread* curThread_w1912aaab7b1c14 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r2.o = curThread_w1912aaab7b1c14->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r2;
