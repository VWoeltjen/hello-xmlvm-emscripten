...
JAVA_OBJECT java_util_HashSet_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w6053aaab9b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w6053aaab9b1b2)
    XMLVM_CATCH_END(w6053aaab9b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w6053aaab9b1b2)
    label16:;
    XMLVM_SOURCE_POSITION("HashSet.java", 124)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label17:;
    java_lang_Thread* curThread_w6053aaab9b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w6053aaab9b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label16;
    //XMLVM_END_WRAPPER
}
