...
JAVA_OBJECT java_lang_Throwable_initCause___java_lang_Throwable(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w316aaac20b1b5)
    // Begin try
    XMLVM_CHECK_NPE(2)
    _r0.o = ((java_lang_Throwable*) _r2.o)->fields.java_lang_Throwable.cause_;
    if (_r0.o != _r2.o) { XMLVM_MEMCPY(curThread_w316aaac20b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w316aaac20b1b5, sizeof(XMLVM_JMP_BUF)); goto label22; };
    XMLVM_SOURCE_POSITION("Throwable.java", 350)
    if (_r3.o == _r2.o) { XMLVM_MEMCPY(curThread_w316aaac20b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w316aaac20b1b5, sizeof(XMLVM_JMP_BUF)); goto label11; };
    XMLVM_SOURCE_POSITION("Throwable.java", 351)
    XMLVM_CHECK_NPE(2)
    ((java_lang_Throwable*) _r2.o)->fields.java_lang_Throwable.cause_ = _r3.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w316aaac20b1b5)
        XMLVM_CATCH_SPECIFIC(w316aaac20b1b5,java_lang_Object,19)
    XMLVM_CATCH_END(w316aaac20b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w316aaac20b1b5)
    XMLVM_SOURCE_POSITION("Throwable.java", 352)
    java_lang_Object_releaseLockRecursive__(_r2.o);
    XMLVM_EXIT_METHOD()
    return _r2.o;
    label11:;
    XMLVM_TRY_BEGIN(w316aaac20b1c10)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w316aaac20b1c10)
        XMLVM_CATCH_SPECIFIC(w316aaac20b1c10,java_lang_Object,19)
    XMLVM_CATCH_END(w316aaac20b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w316aaac20b1c10)
    label19:;
    java_lang_Thread* curThread_w316aaac20b1c12 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w316aaac20b1c12->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r2.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    label22:;
    XMLVM_TRY_BEGIN(w316aaac20b1c16)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w316aaac20b1c16)
        XMLVM_CATCH_SPECIFIC(w316aaac20b1c16,java_lang_Object,19)
    XMLVM_CATCH_END(w316aaac20b1c16)
    XMLVM_RESTORE_EXCEPTION_ENV(w316aaac20b1c16)
    //XMLVM_END_WRAPPER
}
