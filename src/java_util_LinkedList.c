...
void __INIT_IMPL_java_util_LinkedList()
{
    ...
    if (!__TIB_java_util_Deque.classInitialized) __INIT_java_util_Deque();
...
{
    if (!__TIB_java_util_LinkedList.classInitialized) __INIT_java_util_LinkedList();
...
JAVA_OBJECT java_util_LinkedList_clone__(JAVA_OBJECT me)
{
    ...
    _r6.o = me;
    _r5.o = JAVA_NULL;
    XMLVM_TRY_BEGIN(w831aaac14b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w831aaac14b1b3)
    XMLVM_CATCH_END(w831aaac14b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w831aaac14b1b3)
    label35:;
    XMLVM_SOURCE_POSITION("LinkedList.java", 466)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label36:;
    java_lang_Thread* curThread_w831aaac14b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w831aaac14b1b8->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r5;
    goto label35;
    //XMLVM_END_WRAPPER
}
