...
void java_util_ArrayList___CLINIT_()
{
    ...
    // "size"
    _r3.o = xmlvm_create_java_string_from_pool(158);
...
JAVA_OBJECT java_util_ArrayList_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w2416aaac15b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w2416aaac15b1b2)
    XMLVM_CATCH_END(w2416aaac15b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w2416aaac15b1b2)
    label16:;
    XMLVM_SOURCE_POSITION("ArrayList.java", 290)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label17:;
    java_lang_Thread* curThread_w2416aaac15b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w2416aaac15b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label16;
    //XMLVM_END_WRAPPER
}
...
void java_util_ArrayList_writeObject___java_io_ObjectOutputStream(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    // "size"
    _r1.o = xmlvm_create_java_string_from_pool(158);
    XMLVM_CHECK_NPE(3)
