...
JAVA_OBJECT java_lang_Class_getResource___java_lang_String(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w466aaac44b1c26)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w466aaac44b1c26)
    XMLVM_CATCH_END(w466aaac44b1c26)
    XMLVM_RESTORE_EXCEPTION_ENV(w466aaac44b1c26)
    label67:;
    ...
    java_lang_Thread* curThread_w466aaac44b1c59 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r4.o = curThread_w466aaac44b1c59->fields.java_lang_Thread.xmlvmException_;
    _r1 = _r4;
...
JAVA_OBJECT java_lang_Class_getResourceAsStream___java_lang_String(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    return _r2.o;
    label8:;
    XMLVM_TRY_BEGIN(w466aaac45b1c12)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w466aaac45b1c12)
        XMLVM_CATCH_SPECIFIC(w466aaac45b1c12,java_io_IOException,13)
    XMLVM_CATCH_END(w466aaac45b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w466aaac45b1c12)
    goto label7;
    label13:;
    XMLVM_SOURCE_POSITION("Class.java", 848)
    java_lang_Thread* curThread_w466aaac45b1c16 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w466aaac45b1c16->fields.java_lang_Thread.xmlvmException_;
    goto label7;
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_lang_Class_getTypeParameters__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w466aaac48b1b4)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w466aaac48b1b4)
        XMLVM_CATCH_SPECIFIC(w466aaac48b1b4,java_lang_Object,24)
    XMLVM_CATCH_END(w466aaac48b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w466aaac48b1b4)
    java_lang_Object_releaseLockRecursive__(_r2.o);
    XMLVM_EXIT_METHOD()
    return _r1.o;
    label24:;
    java_lang_Thread* curThread_w466aaac48b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w466aaac48b1b8->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r2.o);
