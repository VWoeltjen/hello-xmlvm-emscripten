...
{
    if (!__TIB_org_apache_harmony_niochar_CharsetProviderImpl_1.classInitialized) __INIT_org_apache_harmony_niochar_CharsetProviderImpl_1();
...
JAVA_OBJECT org_apache_harmony_niochar_CharsetProviderImpl_1_run__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r6;
    _r6.o = me;
    XMLVM_TRY_BEGIN(w3451aaab5b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3451aaab5b1b2)
        XMLVM_CATCH_SPECIFIC(w3451aaab5b1b2,java_lang_Exception,45)
    XMLVM_CATCH_END(w3451aaab5b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w3451aaab5b1b2)
    label44:;
    ...
    java_lang_Thread* curThread_w3451aaab5b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r3.o = curThread_w3451aaab5b1b8->fields.java_lang_Thread.xmlvmException_;
    _r2 = _r3;
    _r3.o = JAVA_NULL;
    goto label44;
    //XMLVM_END_WRAPPER
