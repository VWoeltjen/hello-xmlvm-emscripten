...
JAVA_OBJECT java_util_MapEntry_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r1;
    _r1.o = me;
    XMLVM_TRY_BEGIN(w6017aaab4b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w6017aaab4b1b2)
    XMLVM_CATCH_END(w6017aaab4b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w6017aaab4b1b2)
    label4:;
    XMLVM_SOURCE_POSITION("MapEntry.java", 46)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label5:;
    java_lang_Thread* curThread_w6017aaab4b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w6017aaab4b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label4;
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_util_MapEntry_toString__(JAVA_OBJECT me)
{
    ...
    // "="
    _r1.o = xmlvm_create_java_string_from_pool(645);
    XMLVM_CHECK_NPE(0)
