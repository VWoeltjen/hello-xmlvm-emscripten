...
JAVA_OBJECT java_util_Locale_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w375aaac33b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w375aaac33b1b2)
    XMLVM_CATCH_END(w375aaac33b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w375aaac33b1b2)
    label4:;
    ...
    java_lang_Thread* curThread_w375aaac33b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w375aaac33b1b8->fields.java_lang_Thread.xmlvmException_;
    _r1.o = JAVA_NULL;
    goto label4;
    //XMLVM_END_WRAPPER
}
...
JAVA_INT java_util_Locale_hashCode__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w375aaac52b1b4)
    // Begin try
    XMLVM_CHECK_NPE(2)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w375aaac52b1b4)
        XMLVM_CATCH_SPECIFIC(w375aaac52b1b4,java_lang_Object,23)
    XMLVM_CATCH_END(w375aaac52b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w375aaac52b1b4)
    _r0.i = _r0.i + _r1.i;
    java_lang_Object_releaseLockRecursive__(_r2.o);
    XMLVM_EXIT_METHOD()
    return _r0.i;
    label23:;
    java_lang_Thread* curThread_w375aaac52b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w375aaac52b1b9->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r2.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
...
void java_util_Locale_setDefault___java_util_Locale(JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w375aaac53b1b6)
    // Begin try
    XMLVM_SOURCE_POSITION("Locale.java", 566)
    java_util_Locale_PUT_defaultLocale( _r2.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w375aaac53b1b6)
        XMLVM_CATCH_SPECIFIC(w375aaac53b1b6,java_lang_Object,15)
    XMLVM_CATCH_END(w375aaac53b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w375aaac53b1b6)
    XMLVM_SOURCE_POSITION("Locale.java", 570)
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_EXIT_METHOD()
    return;
    label9:;
    XMLVM_TRY_BEGIN(w375aaac53b1c11)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w375aaac53b1c11)
        XMLVM_CATCH_SPECIFIC(w375aaac53b1c11,java_lang_Object,15)
    XMLVM_CATCH_END(w375aaac53b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w375aaac53b1c11)
    label15:;
    java_lang_Thread* curThread_w375aaac53b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w375aaac53b1c13->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r0.o);
    XMLVM_THROW_CUSTOM(_r1.o)
    //XMLVM_END_WRAPPER
}
