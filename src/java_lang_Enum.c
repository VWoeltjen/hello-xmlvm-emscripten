...
JAVA_OBJECT java_lang_Enum_getValues___java_lang_Class(JAVA_OBJECT n1)
{
    ...
    _r3.o = n1;
    _r2.o = JAVA_NULL;
    XMLVM_TRY_BEGIN(w6173aaac13b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w6173aaac13b1b3)
        XMLVM_CATCH_SPECIFIC(w6173aaac13b1b3,java_lang_Exception,21)
    XMLVM_CATCH_END(w6173aaac13b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w6173aaac13b1b3)
    _r0 = _r3;
    label20:;
    ...
    return _r0.o;
    label21:;
    java_lang_Thread* curThread_w6173aaac13b1b9 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w6173aaac13b1b9->fields.java_lang_Thread.xmlvmException_;
    _r0 = _r2;
    goto label20;
    //XMLVM_END_WRAPPER
}
