...
void java_util_PropertyPermission___CLINIT_()
{
    ...
    // "actions"
    _r3.o = xmlvm_create_java_string_from_pool(665);
...
void java_util_PropertyPermission_decodeActions___java_lang_String(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    // " \011\012\015,"
    _r2.o = xmlvm_create_java_string_from_pool(666);
    XMLVM_CHECK_NPE(0)
...
JAVA_OBJECT java_util_PropertyPermission_getActions__(JAVA_OBJECT me)
{
    ...
    // "read,write"
    _r0.o = xmlvm_create_java_string_from_pool(669);
    label10:;
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label11:;
    // "read"
    _r0.o = xmlvm_create_java_string_from_pool(667);
    goto label10;
    label14:;
    // "write"
    _r0.o = xmlvm_create_java_string_from_pool(668);
    goto label10;
    //XMLVM_END_WRAPPER
}
