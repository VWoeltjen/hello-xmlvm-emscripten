...
JAVA_LONG java_io_ObjectStreamField_getFieldID___org_apache_harmony_misc_accessors_ObjectAccessor_java_lang_Class(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    return _r0.l;
    label11:;
    XMLVM_TRY_BEGIN(w220aaab9b1c15)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w220aaab9b1c15)
    XMLVM_CATCH_END(w220aaab9b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w220aaab9b1c15)
    label19:;
    XMLVM_CHECK_NPE(4)
    _r0.l = ((java_io_ObjectStreamField*) _r4.o)->fields.java_io_ObjectStreamField.assocFieldID_;
    goto label10;
    ...
    java_lang_Thread* curThread_w220aaab9b1c21 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w220aaab9b1c21->fields.java_lang_Thread.xmlvmException_;
    _r0.l = -2;
    XMLVM_CHECK_NPE(4)
    ((java_io_ObjectStreamField*) _r4.o)->fields.java_io_ObjectStreamField.assocFieldID_ = _r0.l;
    goto label19;
...
void java_io_ObjectStreamField_resolve___java_lang_ClassLoader(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    _r1.i = 0;
    XMLVM_TRY_BEGIN(w220aaac26b1c42)
    // Begin try
    ...
    if (_r1.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w220aaac26b1c42->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w220aaac26b1c42, sizeof(XMLVM_JMP_BUF)); goto label80; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w220aaac26b1c42)
        XMLVM_CATCH_SPECIFIC(w220aaac26b1c42,java_lang_ClassNotFoundException,78)
    XMLVM_CATCH_END(w220aaac26b1c42)
    XMLVM_RESTORE_EXCEPTION_ENV(w220aaac26b1c42)
    label75:;
    XMLVM_TRY_BEGIN(w220aaac26b1c44)
    // Begin try
    XMLVM_CHECK_NPE(5)
    ((java_io_ObjectStreamField*) _r5.o)->fields.java_io_ObjectStreamField.type_ = _r0.o;
    { XMLVM_MEMCPY(curThread_w220aaac26b1c44->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w220aaac26b1c44, sizeof(XMLVM_JMP_BUF)); goto label36; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w220aaac26b1c44)
        XMLVM_CATCH_SPECIFIC(w220aaac26b1c44,java_lang_ClassNotFoundException,78)
    XMLVM_CATCH_END(w220aaac26b1c44)
    XMLVM_RESTORE_EXCEPTION_ENV(w220aaac26b1c44)
    label78:;
    XMLVM_TRY_BEGIN(w220aaac26b1c46)
    // Begin try
    java_lang_Thread* curThread_w220aaac26b1c46aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w220aaac26b1c46aa->fields.java_lang_Thread.xmlvmException_;
    { XMLVM_MEMCPY(curThread_w220aaac26b1c46->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w220aaac26b1c46, sizeof(XMLVM_JMP_BUF)); goto label36; };
    XMLVM_SOURCE_POSITION("ObjectStreamField.java", 356)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w220aaac26b1c46)
        XMLVM_CATCH_SPECIFIC(w220aaac26b1c46,java_lang_ClassNotFoundException,78)
    XMLVM_CATCH_END(w220aaac26b1c46)
    XMLVM_RESTORE_EXCEPTION_ENV(w220aaac26b1c46)
    label80:;
    XMLVM_TRY_BEGIN(w220aaac26b1c48)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w220aaac26b1c48)
        XMLVM_CATCH_SPECIFIC(w220aaac26b1c48,java_lang_ClassNotFoundException,78)
    XMLVM_CATCH_END(w220aaac26b1c48)
    XMLVM_RESTORE_EXCEPTION_ENV(w220aaac26b1c48)
    _r0 = _r1;
    goto label75;
    //XMLVM_END_WRAPPER
}
