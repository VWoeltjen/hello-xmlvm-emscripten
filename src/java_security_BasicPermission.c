...
JAVA_BOOLEAN java_security_BasicPermission_implies___java_security_Permission(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    _r7.o = n1;
    // "exitVM.*"
    _r4.o = xmlvm_create_java_string_from_pool(164);
    // "exitVM"
    _r3.o = xmlvm_create_java_string_from_pool(165);
    ...
    // "exitVM"
    _r2.o = xmlvm_create_java_string_from_pool(165);
    //java_lang_String_equals___java_lang_Object[1]
    XMLVM_CHECK_NPE(1)
    ...
    // "exitVM.*"
    _r0.o = xmlvm_create_java_string_from_pool(164);
    _r0 = _r1;
    _r1 = _r4;
    label51:;
