...
JAVA_OBJECT org_apache_harmony_luni_util_FloatingPointParser_initialParse___java_lang_String_int(JAVA_OBJECT n1, JAVA_INT n2)
{
    ...
    _r2.i = _r2.i + 1;
    label102:;
    XMLVM_TRY_BEGIN(w1916aaab3b1c74)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1916aaab3b1c74)
    XMLVM_CATCH_END(w1916aaab3b1c74)
    XMLVM_RESTORE_EXCEPTION_ENV(w1916aaab3b1c74)
    _r11 = _r2;
    _r2 = _r1;
    _r1 = _r11;
    label113:;
    ...
    java_lang_Thread* curThread_w1916aaab3b1c87 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1916aaab3b1c87->fields.java_lang_Thread.xmlvmException_;
