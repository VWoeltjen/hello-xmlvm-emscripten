...
void __INIT_IMPL_java_net_ConnectException()
{
    ...
    if (!__TIB_java_net_SocketException.classInitialized) __INIT_java_net_SocketException();
...
{
    if (!__TIB_java_net_ConnectException.classInitialized) __INIT_java_net_ConnectException();
