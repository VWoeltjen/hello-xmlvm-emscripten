...
JAVA_OBJECT java_util_HashMap_clone__(JAVA_OBJECT me)
{
    ...
    XMLVMElem _r2;
    _r2.o = me;
    XMLVM_TRY_BEGIN(w2046aaac14b1b2)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w2046aaac14b1b2)
    XMLVM_CATCH_END(w2046aaac14b1b2)
    XMLVM_RESTORE_EXCEPTION_ENV(w2046aaac14b1b2)
    label21:;
    XMLVM_SOURCE_POSITION("HashMap.java", 381)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label22:;
    java_lang_Thread* curThread_w2046aaac14b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w2046aaac14b1b7->fields.java_lang_Thread.xmlvmException_;
    _r0.o = JAVA_NULL;
    goto label21;
    //XMLVM_END_WRAPPER
}
