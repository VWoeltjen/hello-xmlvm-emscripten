...
void java_util_Collections_copy___java_util_List_java_util_List(JAVA_OBJECT n1, JAVA_OBJECT n2)
{
    ...
    _r5.o = n2;
    // "luni.38"
    _r3.o = xmlvm_create_java_string_from_pool(807);
    ...
    return;
    label43:;
    XMLVM_TRY_BEGIN(w5638aaab7b1c27)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w5638aaab7b1c27)
    XMLVM_CATCH_END(w5638aaab7b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w5638aaab7b1c27)
    ...
    java_lang_Thread* curThread_w5638aaab7b1c34 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w5638aaab7b1c34->fields.java_lang_Thread.xmlvmException_;
