...
JAVA_OBJECT java_nio_charset_CoderResult_malformedForLength___int(JAVA_INT n1)
{
    ...
    XMLVM_TRY_BEGIN(w3417aaac12b1b6)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1b6)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1b6,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac12b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1b6)
    XMLVM_TRY_BEGIN(w3417aaac12b1b7)
    // Begin try
    ...
    if (_r0.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w3417aaac12b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w3417aaac12b1b7, sizeof(XMLVM_JMP_BUF)); goto label33; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1b7)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1b7,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac12b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1b7)
    label33:;
    XMLVM_TRY_BEGIN(w3417aaac12b1b9)
    // Begin try
    XMLVM_SOURCE_POSITION("CoderResult.java", 123)
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1b9)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1b9,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac12b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1b9)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label36:;
    java_lang_Thread* curThread_w3417aaac12b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3417aaac12b1c13->fields.java_lang_Thread.xmlvmException_;
    XMLVM_TRY_BEGIN(w3417aaac12b1c14)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1c14)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1c14,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac12b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1c14)
    XMLVM_TRY_BEGIN(w3417aaac12b1c15)
    // Begin try
    XMLVM_THROW_CUSTOM(_r0.o)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1c15)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1c15,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac12b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1c15)
    label39:;
    java_lang_Thread* curThread_w3417aaac12b1c17 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3417aaac12b1c17->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    label42:;
    XMLVM_TRY_BEGIN(w3417aaac12b1c21)
    // Begin try
    ...
    // "niochar.08"
    _r2.o = xmlvm_create_java_string_from_pool(177);
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac12b1c21)
        XMLVM_CATCH_SPECIFIC(w3417aaac12b1c21,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac12b1c21)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac12b1c21)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_nio_charset_CoderResult_unmappableForLength___int(JAVA_INT n1)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r1.o);
    if (_r5.i <= 0) goto label42;
    XMLVM_TRY_BEGIN(w3417aaac13b1b6)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1b6)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1b6,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac13b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1b6)
    XMLVM_TRY_BEGIN(w3417aaac13b1b7)
    // Begin try
    ...
    if (_r0.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w3417aaac13b1b7->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w3417aaac13b1b7, sizeof(XMLVM_JMP_BUF)); goto label33; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1b7)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1b7,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac13b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1b7)
    label33:;
    XMLVM_TRY_BEGIN(w3417aaac13b1b9)
    // Begin try
    XMLVM_SOURCE_POSITION("CoderResult.java", 152)
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1b9)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1b9,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac13b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1b9)
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label36:;
    java_lang_Thread* curThread_w3417aaac13b1c13 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3417aaac13b1c13->fields.java_lang_Thread.xmlvmException_;
    XMLVM_TRY_BEGIN(w3417aaac13b1c14)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1c14)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1c14,java_lang_Object,36)
    XMLVM_CATCH_END(w3417aaac13b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1c14)
    XMLVM_TRY_BEGIN(w3417aaac13b1c15)
    // Begin try
    XMLVM_THROW_CUSTOM(_r0.o)
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1c15)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1c15,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac13b1c15)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1c15)
    label39:;
    java_lang_Thread* curThread_w3417aaac13b1c17 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3417aaac13b1c17->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r1.o);
    XMLVM_THROW_CUSTOM(_r0.o)
    label42:;
    XMLVM_TRY_BEGIN(w3417aaac13b1c21)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3417aaac13b1c21)
        XMLVM_CATCH_SPECIFIC(w3417aaac13b1c21,java_lang_Object,39)
    XMLVM_CATCH_END(w3417aaac13b1c21)
    XMLVM_RESTORE_EXCEPTION_ENV(w3417aaac13b1c21)
    //XMLVM_END_WRAPPER
}
...
JAVA_OBJECT java_nio_charset_CoderResult_toString__(JAVA_OBJECT me)
{
    ...
    // "CoderResult["
    _r2.o = xmlvm_create_java_string_from_pool(179);
    XMLVM_CHECK_NPE(1)
