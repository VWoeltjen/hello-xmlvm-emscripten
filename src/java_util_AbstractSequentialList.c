...
{
    if (!__TIB_java_util_AbstractSequentialList.classInitialized) __INIT_java_util_AbstractSequentialList();
...
JAVA_OBJECT java_util_AbstractSequentialList_get___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    _r1.o = me;
    _r2.i = n1;
    XMLVM_TRY_BEGIN(w3651aaab3b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3651aaab3b1b3)
    XMLVM_CATCH_END(w3651aaab3b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w3651aaab3b1b3)
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label9:;
    XMLVM_SOURCE_POSITION("AbstractSequentialList.java", 57)
    java_lang_Thread* curThread_w3651aaab3b1b7 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3651aaab3b1b7->fields.java_lang_Thread.xmlvmException_;
...
JAVA_OBJECT java_util_AbstractSequentialList_remove___int(JAVA_OBJECT me, JAVA_INT n1)
{
    ...
    _r2.o = me;
    _r3.i = n1;
    XMLVM_TRY_BEGIN(w3651aaab6b1b3)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w3651aaab6b1b3)
    XMLVM_CATCH_END(w3651aaab6b1b3)
    XMLVM_RESTORE_EXCEPTION_ENV(w3651aaab6b1b3)
    XMLVM_SOURCE_POSITION("AbstractSequentialList.java", 75)
    XMLVM_EXIT_METHOD()
    return _r1.o;
    label12:;
    XMLVM_SOURCE_POSITION("AbstractSequentialList.java", 77)
    java_lang_Thread* curThread_w3651aaab6b1b8 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w3651aaab6b1b8->fields.java_lang_Thread.xmlvmException_;
    _r0.o = __NEW_java_lang_IndexOutOfBoundsException();
    XMLVM_CHECK_NPE(0)
    java_lang_IndexOutOfBoundsException___INIT___(_r0.o);
    XMLVM_THROW_CUSTOM(_r0.o)
