...
void org_apache_harmony_luni_platform_OSFileSystem_validateLockArgs___int_long_long(JAVA_OBJECT me, JAVA_INT n1, JAVA_LONG n2, JAVA_LONG n3)
{
    ...
    _r1.o = xmlvm_create_java_string_from_pool(95);
    ...
    _r1.o = xmlvm_create_java_string_from_pool(96);
...
JAVA_LONG org_apache_harmony_luni_platform_OSFileSystem_open___byte_1ARRAY_int(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_INT n2)
{
    ...
    XMLVM_TRY_BEGIN(w1665aaac30b1c17)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1665aaac30b1c17)
    XMLVM_CATCH_END(w1665aaac30b1c17)
    XMLVM_RESTORE_EXCEPTION_ENV(w1665aaac30b1c17)
    label31:;
    XMLVM_SOURCE_POSITION("OSFileSystem.java", 237)
    java_lang_Thread* curThread_w1665aaac30b1c20 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1665aaac30b1c20->fields.java_lang_Thread.xmlvmException_;
