...
JAVA_OBJECT org_xmlvm_runtime_FinalizerNotifier_startFinalizerThread__()
{
    ...
    XMLVM_TRY_BEGIN(w1726aaab6b1b4)
    // Begin try
    XMLVM_SOURCE_POSITION("FinalizerNotifier.java", 33)
    _r1.o = org_xmlvm_runtime_FinalizerNotifier_GET_finalizerThread();
    if (_r1.o != JAVA_NULL) { XMLVM_MEMCPY(curThread_w1726aaab6b1b4->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1726aaab6b1b4, sizeof(XMLVM_JMP_BUF)); goto label32; };
    ...
    _r1.o = org_xmlvm_runtime_FinalizerNotifier_GET_finalizerThread();
    // "Finalizer-thread"
    _r2.o = xmlvm_create_java_string_from_pool(98);
    XMLVM_CHECK_NPE(1)
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1726aaab6b1b4)
        XMLVM_CATCH_SPECIFIC(w1726aaab6b1b4,java_lang_Object,36)
    XMLVM_CATCH_END(w1726aaab6b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w1726aaab6b1b4)
    label32:;
    XMLVM_TRY_BEGIN(w1726aaab6b1b6)
    // Begin try
    XMLVM_SOURCE_POSITION("FinalizerNotifier.java", 87)
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1726aaab6b1b6)
        XMLVM_CATCH_SPECIFIC(w1726aaab6b1b6,java_lang_Object,36)
    XMLVM_CATCH_END(w1726aaab6b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w1726aaab6b1b6)
    XMLVM_SOURCE_POSITION("FinalizerNotifier.java", 89)
    _r0.o = org_xmlvm_runtime_FinalizerNotifier_GET_finalizerThread();
    XMLVM_EXIT_METHOD()
    return _r0.o;
    label36:;
    java_lang_Thread* curThread_w1726aaab6b1c11 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r1.o = curThread_w1726aaab6b1c11->fields.java_lang_Thread.xmlvmException_;
    XMLVM_TRY_BEGIN(w1726aaab6b1c12)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r0.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1726aaab6b1c12)
        XMLVM_CATCH_SPECIFIC(w1726aaab6b1c12,java_lang_Object,36)
    XMLVM_CATCH_END(w1726aaab6b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w1726aaab6b1c12)
