...
{
    if (!__TIB_java_lang_ref_ReferenceQueue.classInitialized) __INIT_java_lang_ref_ReferenceQueue();
...
JAVA_OBJECT java_lang_ref_ReferenceQueue_poll__(JAVA_OBJECT me)
{
    ...
    XMLVM_TRY_BEGIN(w1548aaab7b1b4)
    // Begin try
    ...
    if (_r0.i == 0) { XMLVM_MEMCPY(curThread_w1548aaab7b1b4->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab7b1b4, sizeof(XMLVM_JMP_BUF)); goto label8; };
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 67)
    java_lang_Object_releaseLockRecursive__(_r3.o);
    _r0.o = JAVA_NULL;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1b4)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1b4,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1b4)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1b4)
    label7:;
    XMLVM_TRY_BEGIN(w1548aaab7b1b6)
    // Begin try
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 78)
    XMLVM_MEMCPY(curThread_w1548aaab7b1b6->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab7b1b6, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1b6)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1b6,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1b6)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1b6)
    label8:;
    XMLVM_TRY_BEGIN(w1548aaab7b1b8)
    // Begin try
    ...
    if (_r1.i != _r2.i) { XMLVM_MEMCPY(curThread_w1548aaab7b1b8->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab7b1b8, sizeof(XMLVM_JMP_BUF)); goto label31; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1b8)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1b8,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1b8)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1b8)
    label31:;
    XMLVM_TRY_BEGIN(w1548aaab7b1c10)
    // Begin try
    ...
    if (_r1.i != _r2.i) { XMLVM_MEMCPY(curThread_w1548aaab7b1c10->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab7b1c10, sizeof(XMLVM_JMP_BUF)); goto label40; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1c10)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1c10,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1c10)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1c10)
    label40:;
    XMLVM_TRY_BEGIN(w1548aaab7b1c12)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    { XMLVM_MEMCPY(curThread_w1548aaab7b1c12->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab7b1c12, sizeof(XMLVM_JMP_BUF)); goto label7; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1c12)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1c12,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1c12)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1c12)
    label42:;
    XMLVM_TRY_BEGIN(w1548aaab7b1c14)
    // Begin try
    java_lang_Thread* curThread_w1548aaab7b1c14aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1548aaab7b1c14aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab7b1c14)
        XMLVM_CATCH_SPECIFIC(w1548aaab7b1c14,java_lang_Object,42)
    XMLVM_CATCH_END(w1548aaab7b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab7b1c14)
...
JAVA_OBJECT java_lang_ref_ReferenceQueue_remove___long(JAVA_OBJECT me, JAVA_LONG n1)
{
    ...
    java_lang_Object_acquireLockRecursive__(_r3.o);
    XMLVM_TRY_BEGIN(w1548aaab9b1c14)
    // Begin try
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 118)
    XMLVM_CHECK_NPE(3)
    _r0.i = ((java_lang_ref_ReferenceQueue*) _r3.o)->fields.java_lang_ref_ReferenceQueue.empty_;
    if (_r0.i == 0) { XMLVM_MEMCPY(curThread_w1548aaab9b1c14->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab9b1c14, sizeof(XMLVM_JMP_BUF)); goto label27; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c14)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c14,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c14)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c14)
    label26:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c16)
    // Begin try
    XMLVM_SOURCE_POSITION("ReferenceQueue.java", 135)
    XMLVM_MEMCPY(curThread_w1548aaab9b1c16->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab9b1c16, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.o;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c16)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c16,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c16)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c16)
    label27:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c18)
    // Begin try
    ...
    _r2.o = ((java_lang_ref_ReferenceQueue*) _r3.o)->fields.java_lang_ref_ReferenceQueue.references_;
    _r2.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r2.o));
    if (_r1.i != _r2.i) { XMLVM_MEMCPY(curThread_w1548aaab9b1c18->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab9b1c18, sizeof(XMLVM_JMP_BUF)); goto label50; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c18)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c18,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c18)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c18)
    label50:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c20)
    // Begin try
    ...
    XMLVM_CHECK_NPE(3)
    _r2.i = ((java_lang_ref_ReferenceQueue*) _r3.o)->fields.java_lang_ref_ReferenceQueue.tail_;
    if (_r1.i != _r2.i) { XMLVM_MEMCPY(curThread_w1548aaab9b1c20->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab9b1c20, sizeof(XMLVM_JMP_BUF)); goto label64; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c20)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c20,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c20)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c20)
    label59:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c22)
    // Begin try
    java_lang_Object_releaseLockRecursive__(_r3.o);
    { XMLVM_MEMCPY(curThread_w1548aaab9b1c22->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaab9b1c22, sizeof(XMLVM_JMP_BUF)); goto label26; };
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c22)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c22,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c22)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c22)
    label61:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c24)
    // Begin try
    java_lang_Thread* curThread_w1548aaab9b1c24aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1548aaab9b1c24aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r3.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c24)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c24,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c24)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c24)
    XMLVM_THROW_CUSTOM(_r0.o)
    label64:;
    XMLVM_TRY_BEGIN(w1548aaab9b1c27)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaab9b1c27)
        XMLVM_CATCH_SPECIFIC(w1548aaab9b1c27,java_lang_Object,61)
    XMLVM_CATCH_END(w1548aaab9b1c27)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaab9b1c27)
    goto label59;
    //XMLVM_END_WRAPPER
}
...
JAVA_BOOLEAN java_lang_ref_ReferenceQueue_enqueue___java_lang_ref_Reference(JAVA_OBJECT me, JAVA_OBJECT n1)
{
    ...
    XMLVM_TRY_BEGIN(w1548aaac10b1b5)
    // Begin try
    ...
    if (_r0.i != 0) { XMLVM_MEMCPY(curThread_w1548aaac10b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaac10b1b5, sizeof(XMLVM_JMP_BUF)); goto label68; };
    XMLVM_CHECK_NPE(6)
    ...
    if (_r0.i != _r1.i) { XMLVM_MEMCPY(curThread_w1548aaac10b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaac10b1b5, sizeof(XMLVM_JMP_BUF)); goto label68; };
    ...
    XMLVM_CHECK_NPE(6)
    _r1.i = ((java_lang_ref_ReferenceQueue*) _r6.o)->fields.java_lang_ref_ReferenceQueue.tail_;
    if (_r1.i <= 0) { XMLVM_MEMCPY(curThread_w1548aaac10b1b5->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaac10b1b5, sizeof(XMLVM_JMP_BUF)); goto label58; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaac10b1b5)
        XMLVM_CATCH_SPECIFIC(w1548aaac10b1b5,java_lang_Object,97)
    XMLVM_CATCH_END(w1548aaac10b1b5)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaac10b1b5)
    label58:;
    XMLVM_TRY_BEGIN(w1548aaac10b1b7)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaac10b1b7)
        XMLVM_CATCH_SPECIFIC(w1548aaac10b1b7,java_lang_Object,97)
    XMLVM_CATCH_END(w1548aaac10b1b7)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaac10b1b7)
    label68:;
    XMLVM_TRY_BEGIN(w1548aaac10b1b9)
    // Begin try
    ...
    _r1.o = ((java_lang_ref_ReferenceQueue*) _r6.o)->fields.java_lang_ref_ReferenceQueue.references_;
    _r1.i = XMLVMArray_count(((org_xmlvm_runtime_XMLVMArray*) _r1.o));
    if (_r0.i != _r1.i) { XMLVM_MEMCPY(curThread_w1548aaac10b1b9->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaac10b1b9, sizeof(XMLVM_JMP_BUF)); goto label88; };
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaac10b1b9)
        XMLVM_CATCH_SPECIFIC(w1548aaac10b1b9,java_lang_Object,97)
    XMLVM_CATCH_END(w1548aaac10b1b9)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaac10b1b9)
    label88:;
    XMLVM_TRY_BEGIN(w1548aaac10b1c11)
    // Begin try
    ...
    _r0.i = 1;
    XMLVM_MEMCPY(curThread_w1548aaac10b1c11->fields.java_lang_Thread.xmlvmExceptionEnv_, local_env_w1548aaac10b1c11, sizeof(XMLVM_JMP_BUF));
    XMLVM_EXIT_METHOD()
    return _r0.i;
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaac10b1c11)
        XMLVM_CATCH_SPECIFIC(w1548aaac10b1c11,java_lang_Object,97)
    XMLVM_CATCH_END(w1548aaac10b1c11)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaac10b1c11)
    label97:;
    XMLVM_TRY_BEGIN(w1548aaac10b1c13)
    // Begin try
    java_lang_Thread* curThread_w1548aaac10b1c13aa = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w1548aaac10b1c13aa->fields.java_lang_Thread.xmlvmException_;
    java_lang_Object_releaseLockRecursive__(_r6.o);
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w1548aaac10b1c13)
        XMLVM_CATCH_SPECIFIC(w1548aaac10b1c13,java_lang_Object,97)
    XMLVM_CATCH_END(w1548aaac10b1c13)
    XMLVM_RESTORE_EXCEPTION_ENV(w1548aaac10b1c13)
    XMLVM_THROW_CUSTOM(_r0.o)
    //XMLVM_END_WRAPPER
}
