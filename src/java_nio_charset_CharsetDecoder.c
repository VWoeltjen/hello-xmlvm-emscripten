...
void java_nio_charset_CharsetDecoder___INIT____java_nio_charset_Charset_float_float(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_FLOAT n2, JAVA_FLOAT n3)
{
    ...
    // "\177775"
    _r0.o = xmlvm_create_java_string_from_pool(721);
    XMLVM_CHECK_NPE(2)
...
JAVA_OBJECT java_nio_charset_CharsetDecoder_decode___java_nio_ByteBuffer_java_nio_CharBuffer_boolean(JAVA_OBJECT me, JAVA_OBJECT n1, JAVA_OBJECT n2, JAVA_BOOLEAN n3)
{
    ...
    label35:;
    XMLVM_TRY_BEGIN(w4727aaac17b1c29)
    // Begin try
    ...
    // End try
    XMLVM_TRY_END
    XMLVM_CATCH_BEGIN(w4727aaac17b1c29)
    XMLVM_CATCH_END(w4727aaac17b1c29)
    XMLVM_RESTORE_EXCEPTION_ENV(w4727aaac17b1c29)
    ...
    java_lang_Thread* curThread_w4727aaac17b1c54 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w4727aaac17b1c54->fields.java_lang_Thread.xmlvmException_;
    ...
    java_lang_Thread* curThread_w4727aaac17b1c61 = (java_lang_Thread*)java_lang_Thread_currentThread__();
    _r0.o = curThread_w4727aaac17b1c61->fields.java_lang_Thread.xmlvmException_;
